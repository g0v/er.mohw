...
(function(){
  var csv, execSync, fs, q, minimist, shelljs, influx, argv, update, only, genmap, influxHost, influxDb, influxUser, influxPass, file, header, client, records, onEntry, toString$ = {}.toString;
  csv = require('csv');
